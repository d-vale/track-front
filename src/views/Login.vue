  ...
  <div class="flex flex-col items-center gap-8 min-h-screen justify-center">
    ...
    >
      ...
      <input
        ...
        class="px-4 py-2 rounded-lg border border-gray-600 bg-transparent focus:outline-none focus:border-indigo-500"
      />
      <button type="submit" class="rounded-lg border border-transparent px-5 py-2.5 text-base font-medium bg-[#1a1a1a] cursor-pointer transition-colors hover:border-[#646cff]">Login</button>
    </form>
  </div>
</template>
